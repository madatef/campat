    ...
    <section className="flexCenter flex-col">
        <div className="padding-container max-container w-full pb-24">
            ...
            <div className="flex flex-wrap justify-between gap-5 lg:gap-10">
                ...
                <p className="regular-16 text-gray-30 text-justify xl:max-w-[520px]">
                    "Only with the CAMPAT application will you no longer get lost
                    ...
                    relatives and family to have fun in the wilderness through the 
                ...
                <div className="flexBetween flex-col">
                    <div className="flex w-full flex-col">
                        <div className="flexBetween w-ful">
                            ...
                            <p className="bold-16 ml-4 text-green-50">1hr 58min</p>
                    ...
                    <div className="flex w-full flex-col">
                        ...
                        <h4 className="bold-20 mt-2 whitespace-nowrap">Dahab</h4>
